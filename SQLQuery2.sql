...
ALTER TABLE HOCVIEN  ADD CONSTRAINT GIOITINH_HV CHECK (GIOITINH IN ('Nam', 'Nu') );
ALTER TABLE GIAOVIEN ADD CONSTRAINT GIOITINH_GV CHECK (GIOITINH IN ('Nam', 'Nu') );
...
ALTER TABLE GIANGDAY ADD CONSTRAINT GT_HK CHECK ( HOCKY BETWEEN 1 AND 3)

--8. Học vị của giáo viên chỉ có thể là “CN”, “KS”, “Ths”, ”TS”, ”PTS”.
ALTER TABLE GIAOVIEN  ADD CONSTRAINT HOCVI_GV CHECK (HOCVI IN ('CN', 'KS', 'Ths', 'TS', 'PTS') );
...
CREATE TRIGGER TruongKhoa ON KHOA
FOR INSERT, UPDATE
AS
BEGIN
	IF NOT EXISTS (SELECT * FROM INSERTED I, GIAOVIEN GV
	WHERE I.TRGKHOA = GV.MAGV AND I.MAKHOA = GV.MAKHOA AND ( GV.HOCVI = 'TS' OR GV.HOCVI = 'PTS') )
	BEGIN
		PRINT 'Error: TRUONG KHOA CUA MOT KHOA PHAI THUOC KHOA DO VA HOC VI PHAI LA TS HOAC PTS'
		ROLLBACK TRANSACTION
	END
END
